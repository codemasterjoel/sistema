                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="#" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Editar lsb">
                                            ...
                                            <button wire:click="editar('{{$lsb->id}}')" type="button" class="text-success px-2 py-1 mb-0" data-bs-toggle="modal" data-bs-target="#exampleModal"><span class="material-symbols-outlined">person_edit</span></button>                                                 
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title fs-5 mt-4 text-2xl text-cyan-400 font-bold text-center">REGISTRAR NUEVO LUCHADOR</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="row">
                            <div class="col-xl-4 col-sm-12 mb-xl-0 pt-4">
                                    ...
                                    <div class="w-full rounded-lg">
                                        <div class="flex">
                                            <label class="relative inline-flex cursor-pointer items-center">
                                                @if ($estatus)
                                                    <input wire:click="activo()" type="button" value="ACTIVO" class=" w-24 bg-gradient-to-r from-cyan-400 to-cyan-600 font-bold text-white py-2 rounded-lg mx-auto block">
                                                @else
                                                    <input wire:click="activo()" type="button" value="INACTIVO" class=" w-24 bg-gradient-to-r from-red-400 to-red-600 font-bold text-white py-2 rounded-lg mx-auto block">
                                                @endif
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 mb-xl-0 pt-4">
                                <div class="flex items-stretch">
                                    <span class="flex bg-cyan-400 font-bold text-white items-center whitespace-nowrap rounded-l-lg border border-r-0 border-solid border-neutral-900 px-3 py-[0.25rem] text-center">Fecha de Nacimiento</span>
                                    <input wire:model="fechaNacimiento" type="date" class="w-full flex-auto relative pl-3 border border-solid rounded-r-lg font-bold text-neutral-900 text-uppercase outline-2 border-neutral-900" />
                                        ...
                                        <div class="flex">
                                            <label class="relative inline-flex cursor-pointer items-center">
                                                @if ($pertenece_al_psuv)
                                                    {{-- <input type="hidden" wire:model="pertenece_al_psuv" value="1"> --}}
                                                ...
                                                @else
                                                    {{-- <input type="hidden" wire:model="pertenece_al_psuv" value="0"> --}}
